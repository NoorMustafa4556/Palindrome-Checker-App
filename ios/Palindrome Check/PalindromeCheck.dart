...
import 'PalindromeHistory.dart'; // Ensure this path is correct
// lib/history_manager.dart (or lib/Palindrome Check/history_manager.dart)
class HistoryEntry {
  final String input;
...
class _PalindromecheckState extends State<Palindromecheck> {
  ...
  void _checkPalindrome() {
    ...
    HistoryManager().addEntry(
      PalindromeEntry(inputText, isPalindrome),
    );
